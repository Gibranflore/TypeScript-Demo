...
import confetti from 'canvas-confetti';
    ...
    const handleSkip = () => {
        ...
        const upadateWords = words.slice(1)
        
        setWords(upadateWords)
        setSkipCounter(skipCounter + 1)
        setCurrentWord(upadateWords[0]);
        setScrambledWord(scrambleWord(upadateWords[0]))
        setGuess('')
    };
